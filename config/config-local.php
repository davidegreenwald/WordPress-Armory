...
define( 'WP_SITEURL', $dgdev_local_protocol . $dgdev_domain . $dgdev_local_tld . $dgdev_core );
define( 'WP_HOME', $dgdev_local_protocol . $dgdev_domain . $dgdev_local_tld );
...
define( 'WP_CONTENT_URL', $dgdev_local_protocol . $dgdev_domain . $dgdev_local_tld . $dgdev_content );